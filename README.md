...
<table>
    ...
    <tr>
        <td>
            <code>/demos/Demo19_AWS_S3_React</code>
        </td>
        <td>
...
">AWS IAM and the AWS SDK for Programmatic Access and Cloud Development</a>        
    ...
    <tr>
        <td>
            <code>/demos/Demo34_Arrays_Stacks_Queues</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/your-quick-guide-to-arrays-linkedlists-stacks-and-queues-3492e267a0e7">Your Guide to Arrays, Linked Lists, Stacks, and Queues</a>        
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <a href="https://medium.com/@abdullah_95/task-scheduler-application-implementing-the-lru-cache-062f082f524d">Task Scheduler Application Implementing the LRU Cache</a>
        </td>
    </tr>
    <tr>
        <td>
            <code>/demos/Demo37_Document_Object_Model</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/exploring-the-html-document-object-model-and-the-domparser-ad4f6783710c">Exploring the HTML Document Object Model and the DOMParser</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo43_Selenium_WebDriver_Web_Scraping</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/deep-dive-into-web-scraping-using-selenium-webdriver-94bd482689c4">Deep Dive into Web Scraping using Selenium WebDriver</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <a href="https://medium.com/@abdullah_95/the-aws-ec2-single-tier-architecture-pattern-b3a9d1f201ab">The AWS EC2 Single-Tier Architecture Pattern</a>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <a href="https://medium.com/@abdullah_95/decentralized-storage-utilizing-glacierdb-and-the-blockchain-dac0d24753e9">Decentralized Storage Utilizing GlacierDB and the Blockchain</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <tr>
        <td>
            <code>/demos/Demo54_NextJS_App_Router</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/comprehensive-guide-to-next-js-15-app-router-64e967d700f8">Comprehensive Guide to Next.js 15 App Router</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo56_Crypto_Dashboard</code>
        </td>
        <td>
        ...
        <tr>
        <td>
            <code>/demos/Demo57_Top_React_Libraries</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo59_AWS_AI_Certification</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/your-aws-ai-practitioner-exam-summary-sheet-904c10bae3b0">Your AWS AI Practitioner Exam Summary Sheet</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo66_Ethereum_Hooks_NPM_Package</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/exploring-an-ethereum-hooks-npm-package-644fc67f4cad">Exploring an Ethereum Hooks NPM Package</a>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo72_Bittensor_Intro</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo78_Chutes_AI_Model_Deployment</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/how-to-deploy-a-fine-tuned-llm-on-bittensors-chutes-ai-366c4b89c7d4">How to Deploy a Fine-Tuned LLM on Bittensor’s Chutes AI</a>
        </td>  
    </tr>
        <tr>
        <td>
            <code>/demos/Demo79_HyperLiquid_Dummy_Guide</code>
        </td>
        <td>
            <a href="https://medium.com/@abdullah_95/the-short-dummies-guide-to-the-hyperliquid-l1-blockchain-40827f8a688a">The Short Dummies Guide to the HyperLiquid L1 Blockchain</a>
        </td>  
    </tr>
    <tr>
        <td>
            <code>/demos/Demo80_RTK_Claude_Optimizer</code>
        </td>
        <td>
            <a href="https://medium.com/stackademic/rust-token-killer-save-claude-code-tokens-with-this-rust-binary-761641e76bda">Rust Token Killer: Save Claude Code Tokens with This Rust Binary</a>
        </td> 
    </tr>
    <tr>
        <td>
            <code>/demos/Demo81_N8N_Workflows</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo82_AWS_Claude_Certification_Paths</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo84_N8N_Workflows_Trigger_Dev</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo85_Jenkins_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo86_NextJS_Quickstart_SaaS</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo87_SQL_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo88_Docker_Extended_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo89_Terraform_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo90_Kubernetes_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo91_Linux_Powershell_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo92_Go_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo93_Google_Chrome_Extensions_Guide</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo94_Tailwind_CSS</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo95_Code_IDEs</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo96_React_UI_Libraries</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo97_Vulnerability_Check_Node</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo99_AWS_EC2_No_SSL_Setup</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo100_AWS_EC2_Two_Tier_Architecture</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo101_AWS_Load_Balancing</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo102_AWS_ECS_Docker_Containers</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo103_AWS_CloudFront_Hosting</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo104_AWS_ACM_KMS_Encryption</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo105_AWS_SQS_SNS_SES_Messaging</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo106_AWS_CloudTrail_CloudWatch_Monitoring</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo107_AWS_Lambda_Serverless</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo108_AWS_Lambda_API_Gateway_Development</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo109_AWS_SAM_Serverless_Application_Model</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo110_AWS_AppSync_Step_Functions</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo111_AWS_CLI_Scripting</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo112_AWS_AppSync_Step_Functions</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo113_AWS_CodePipeline_CI_CD</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo114_AWS_Cost_Control</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo115_AWS_Additional_Services</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo116_AWS_CloudFormation_IaC</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo117_AWS_Cloud9_IDE</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo118_AWS_CloudFormation_CodePipeline</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo119_AWS_CloudFormation_Terraform</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo120_AWS_Final_Deployment_Demo</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
...
Table highlighting Medium articles published based on miscellaneous topics
