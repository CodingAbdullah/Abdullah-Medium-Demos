...
">AWS IAM and the AWS SDK for Programmatic Access and Cloud Development</a>        
    ...
    <tr>
        <td>
            <code>/demos/Demo59_AWS_EC2_Two_Tier_Architecture</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo60_AWS_Load_Balancing</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo61_AWS_ECS_Docker_Containers</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo62_AWS_CloudFront_Hosting</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo63_AWS_ACM_KMS_Encryption</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo64_AWS_SQS_SNS_SES_Messaging</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo65_AWS_CloudTrail_CloudWatch_Monitoring</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo66_AWS_Lambda_Serverless</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo67_AWS_Lambda_API_Gateway_Development</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo68_AWS_SAM_Serverless_Application_Model</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo70_AWS_CLI_Scripting</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo72_AWS_CodePipeline_CI_CD</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo73_AWS_Cost_Control</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo74_AWS_Additional_Services</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo75_AWS_CloudFormation_IaC</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo76_AWS_Cloud9_IDE</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo77_AWS_CloudFormation_CodePipeline</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo78_AWS_CloudFormation_Terraform</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo79_Terraform</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo80_AWS_Final_Deployment_Demo</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
