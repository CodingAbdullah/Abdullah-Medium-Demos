...
">AWS IAM and the AWS SDK for Programmatic Access and Cloud Development</a>        
    ...
    <tr>
        <td>
            <code>/demos/Demo59_Firecrawl_Zod_Web_Scraping</code>
        </td>
        <td>
    ...
    <tr>
        <td>
            <code>/demos/Demo60_Vercel_Edge_Functions</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo61_NextJS_AuthJS</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo62_NextJS_TRPC</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo63_NextJS_Supabase</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo64_NextJS_Drizzle</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo66_NextJS_Email_Resend</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        ...
        <tr>
        <td>
            <code>/demos/Demo68_NextJS_Quickstart_SaaS</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo69_Terraform</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
    ...
    <tr>
        <td>
            <code>/demos/Demo70_CI_CD_Jenkins</code>
        </td>
        <td>
            Link to Medium Article to be posted when complete
        </td>
