    ...
    return (
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" style={{ color: 'white' }} href="/"><b>User Posts Site</b></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    {
                        !tokenValue ? 
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a style={{ color: 'white' }} class="nav-link" aria-current="page" href="/register-user">Register</a>
                                </li>
                                <li class="nav-item">
                                    <a style={{ color: 'white' }} class="nav-link" href="/login-user">Login</a>
                                </li>
                                <li class="nav-item">
                                    <a style={{ color: 'grey' }} class="nav-link disabled" href="/create-post">Create Post</a>
                                </li>
                                <li class="nav-item">
                                    <a style={{ color: 'grey' }} class="nav-link disabled" href="/view-posts">View My Posts</a>
                                </li>
                            </ul>
                        :
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a style={{ color: 'grey' }} class="nav-link disabled" aria-current="page" href="/register-user">Register User</a>
                                </li>
                                <li class="nav-item">
