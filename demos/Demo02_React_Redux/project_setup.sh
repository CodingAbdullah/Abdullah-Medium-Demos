...
npm install axios react-redux react-router react-router-dom redux validator
...
mkdir Controller Routes Models
...
npm install axios bcryptjs cors dotenv express jsonwebtoken mongoose 
